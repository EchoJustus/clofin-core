...
| 5 | Settlement simulation | [TASK-004](briefs/004-TASK-settlement-simulation.md) | 🔨 `IMPLEMENTED` — PR #7 open and green (`55566ad`, migration `0009`, ADR-0018); objections ruled; carries the TASK-005 O-3 contract fix; cleared to merge | green, 3435 assertions |
