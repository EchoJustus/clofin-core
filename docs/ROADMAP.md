...
| 5 | Settlement simulation | [TASK-004](briefs/004-TASK-settlement-simulation.md) | 🔨 `IN PROGRESS` — dispatched 2026-08-04; branches off `main` (`2ba977e`); DDL validated per L-3; migration `0009` | — |
