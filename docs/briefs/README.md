...
| [004 — Settlement simulation](004-TASK-settlement-simulation.md) | 5 | `IMPLEMENTED` — PR #7 open and green (`55566ad`); objections ruled; carries the TASK-005 O-3 fix; cleared to merge | 003 ✅, 005 ✅ merged | PRD §5.3 | Large |
...
| [005 — Audit coverage completion](005-TASK-audit-coverage-completion.md) | 4 (completion) | PR #6 (`2ba977e`) | Awaiting Milestone 2 batch audit (with TASK-004); three brief objections ruled at ingestion, all for the Worker |
