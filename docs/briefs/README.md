...
| [004 — Settlement simulation](004-TASK-settlement-simulation.md) | 5 | `CLOSED` — merged in PR #7 (`cba31c5`); three objections ruled; carried the TASK-005 O-3 fix | 003 ✅, 005 ✅ merged | PRD §5.3 | Large |
...
| [004 — Settlement simulation](004-TASK-settlement-simulation.md) | 5 | PR #7 (`cba31c5`) | Awaiting Milestone 2 batch audit (with TASK-005); three brief objections ruled at ingestion |
