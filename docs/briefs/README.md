...
| [015 — `ref-2` release remediation](015-TASK-ref-2-release-remediation.md) | ref-2 | `IN PROGRESS` — dispatched 2026-09-06 against `FEEDBACK-REL-ref-2` (ingested): two blocking, sixteen should-fix, one consider and one residual in the subject; the tag waits on it | audit ✅ ingested | FEEDBACK-REL-ref-2; ADR-0020/0022/0023/0027 | Large |
