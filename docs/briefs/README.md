...
| [011 — `clofin-cockpit` initialization](011-TASK-cockpit-initialization.md) | 8.1 | `IMPLEMENTED` — ADR-0026 merged (PR #21, `eb3a561`); cockpit PR #1 green, merge held on two operator settings (N-4a) | cockpit repo ✅ (`13e6435`) | D5, ADR-0026 | Medium |
