...
| [004-REQ](004-REQ-settlement-simulation.md) | [TASK-004](../briefs/004-TASK-settlement-simulation.md) | 2026-08-04 | **Audited** — [FEEDBACK-M2](FEEDBACK-M2-settlement-and-audit-coverage.md): REMEDIATION-REQUIRED (F-007 blocking, F-008/F-009/F-010); brief reopened, remediation in flight |
