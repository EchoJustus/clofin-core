...
| [004-REQ](004-REQ-settlement-simulation.md) | [TASK-004](../briefs/004-TASK-settlement-simulation.md) | 2026-08-04 | **Audited & remediated** — [FEEDBACK-M2](FEEDBACK-M2-settlement-and-audit-coverage.md): REMEDIATION-REQUIRED; remediation batch `fa31eb7` (PR #8, migration `0010`, ADR-0019) verified by Master Control; pending merge |
